...
class Settings:
    ...
    # Local LLM settings
    llm_provider: str = "ollama"  # ollama | lmstudio | openai_compatible
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            openai_compatible_base_url=compat_url.rstrip("/"),
            local_llm_model=os.getenv("LOCAL_LLM_MODEL", "qwen3:4b").strip() or "auto",
